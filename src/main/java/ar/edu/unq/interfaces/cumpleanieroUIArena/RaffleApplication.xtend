...
class RaffleApplication extends Application
{
	override createMainWindow()
	{
		...
		var p2 = new Person('Juanjo', new LocalDate(2013, 1, 15))
		...
		var p7 = new Person('Piti', new LocalDate(2015, 6, 7))
		var p8 = new Person('Pepe', new LocalDate(2016, 6, 7))
		var p9 = new Person('Sofia', new LocalDate(2012, 7, 7))
		var p10 = new Person('Gise', new LocalDate(2013, 8, 7))
		var p11 = new Person('Nico', new LocalDate(2014, 9, 7))
		var p12 = new Person('Tefi', new LocalDate(2015, 10, 7))
		var p13 = new Person('Alan', new LocalDate(2012, 11, 7))
		var p14 = new Person('Lean', new LocalDate(2013, 11, 7))
